...
class RegisterCustomerUseCaseTest {
    ...
    void saveCustomerSuccessfully() {
        Customer customer = new Customer("42321973899", "Joao Saladinha", "john.doe@example.com");
    ...
    void saveCustomerThrowsExceptionWhenNameIsNull() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            new Customer("42321973899", null, "john.doe@example.com");
        });
    ...
    void saveCustomerThrowsExceptionWhenCpfIsNull() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            new Customer(null, "Joao Saladinha", "john.doe@example.com");
        });
